...
urlpatterns = [
    ...
    path('qr_scanner/<int:event_id>/', views.qr_scanner_mobile, name='qr_scanner_mobile'),
    path('api/validate-qr/<int:event_id>/', views.validate_qr_code_api, name='validate_qr_code_api'),
    ...
    path('set_ingr_booking/<str:number>/<str:seat>/<int:price_code>/', views.set_ingr_booking, name='set_ingr_booking'),
