...
class EventFiscalData(models.Model):
    ...
    abbonamento_ticket_serie_1        = models.CharField(max_length=10, default='', blank=True)
    abbonamento_ticket_start_number_1 = models.IntegerField(verbose_name='Abbonamento dal numero', default=0, null=True, blank=True)
    abbonamento_ticket_end_number_1   = models.IntegerField(verbose_name='Abbonamento al numero', default=0, null=True, blank=True)
    abbonamento_ticket_serie_2        = models.CharField(max_length=10, default='nd', blank=True)
    abbonamento_ticket_start_number_2 = models.IntegerField(verbose_name='Abbonamento dal numero', default=0, null=True, blank=True)
    abbonamento_ticket_end_number_2   = models.IntegerField(verbose_name='Abbonamento al numero', default=0, null=True, blank=True)
    abbonamento_ticket_serie_3        = models.CharField(max_length=10, default='nd', blank=True)
    abbonamento_ticket_start_number_3 = models.IntegerField(verbose_name='Abbonamento dal numero', default=0, null=True, blank=True)
    abbonamento_ticket_end_number_3   = models.IntegerField(verbose_name='Abbonamento al numero', default=0, null=True, blank=True)
    abbonamento_ticket_serie_4        = models.CharField(max_length=10, default='nd', blank=True)
    abbonamento_ticket_start_number_4 = models.IntegerField(verbose_name='Abbonamento dal numero', default=0, null=True, blank=True)
    abbonamento_ticket_end_number_4   = models.IntegerField(verbose_name='Abbonamento al numero', default=0, null=True, blank=True)
