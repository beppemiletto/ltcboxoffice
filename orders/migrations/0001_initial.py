# Generated by Django 4.2 on 2023-05-15 13:33
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('payer_mail', models.CharField(default='', max_length=100)),
                ('payer_id', models.CharField(default='', max_length=100)),
                ('payer_given_name', models.CharField(default='', max_length=100)),
                ('payer_surname', models.CharField(default='', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('event_seat', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='store.event')),
